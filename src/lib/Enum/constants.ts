import type { BoardElement, BoardTheme, Stroke, ToolItem } from '$lib/Type';
...
export const TOOL_ITEMS: ToolItem[] = [
	...
	{ tool: 'eraser-multi', label: 'Eraser (all)', icon: ERASER_MULTI_ICON },
