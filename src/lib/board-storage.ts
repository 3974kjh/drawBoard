...
const migrateFromLocalStorageIfNeeded = async (): Promise<void> => {
...
export const getBoardById = async (id: string): Promise<BoardData | null> => {
...
export const upsertBoard = async (board: BoardData): Promise<BoardData> => {
...
export const createBoard = async (title: string, themeId: ThemeId): Promise<BoardData> => {
